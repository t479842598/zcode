...
test("selfhost version aligns with installed official 3.14.3, keeping its own release target", async () => {
  ...
  const publish = await readFile(new URL("../../../../scripts/publish-release.mjs", import.meta.url), "utf8");
