...
const zhCN: Record<string, string> = {
  ...
  "settings.modelProvider.fetchModels.description": "从 {provider} 拉取可用模型列表，勾选后加入模型列表。",
  ...
  "webRemoteControl.statusDetail.disabled": "自托管中继未启用（可用 ZCODE_SELFHOST_RELAY_DISABLED 控制）。",
