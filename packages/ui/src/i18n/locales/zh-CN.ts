...
const zhCN: Record<string, string> = {
  ...
  "settings.backup.description":
    "把工作区（含 .git）备份到你自己的阿里云 OSS：凭证与加密密码都由你自己持有，全程不经过任何官方服务器。",
  "settings.backup.enabled": "启用备份",
  "settings.backup.enabledDescription": "关闭时不会执行任何备份（含定时备份）。",
  "settings.backup.ossTitle": "OSS 存储",
  "settings.backup.endpointDescription": "区域端点，例如 https://oss-cn-hangzhou.aliyuncs.com",
  "settings.backup.prefix": "路径前缀",
  "settings.backup.secretConfigured": "已配置（只存本机加密存储，不回显）",
  "settings.backup.secretPlaceholderConfigured": "已配置（输入新值覆盖）",
  "settings.backup.encryptionTitle": "加密",
  "settings.backup.encryptionMode": "加密方式",
  "settings.backup.encryptionModeAes": "AES-256-CTR（自持密码）",
  "settings.backup.encryptionModeNone": "不加密",
  "settings.backup.passphrase": "加密密码",
  "settings.backup.passphraseDescription":
    "备份用此密码加密；密码只存本机，凭 envelope.json + 密码可自行解密。",
  "settings.backup.filterTitle": "备份内容",
  "settings.backup.includeGitDir": "包含 .git 目录",
  "settings.backup.includeGitDirDescription": "完整备份 Git 历史（objects/logs/reflog）。",
  "settings.backup.includeGitLfs": "包含 Git LFS 缓存",
  "settings.backup.includeGitLfsDescription": "备份 .git/lfs/objects 大文件缓存。",
  "settings.backup.intervalTitle": "定时备份",
  "settings.backup.interval": "备份间隔（秒）",
  "settings.backup.intervalDescription":
    "0 = 仅手动备份；大于 0 时对最近一次备份的工作区定时执行。",
  "settings.backup.intervalPlaceholder": "0 = 仅手动",
  "settings.backup.manualTitle": "手动备份",
  "settings.backup.manualDescription": "立即对当前活动工作区执行一次备份。",
  "settings.backup.run": "立即备份",
  "settings.backup.running": "备份中…",
  "settings.backup.runSuccess": "备份完成：{count} 个文件 · {size} → {key}",
  "settings.backup.runFailed": "备份失败",
  "settings.backup.runDisabledNoWorkspace": "先打开一个工作区",
  "settings.backup.notConfigured": "请先填写 OSS 配置与加密密码",
  "settings.backup.unsupported": "当前环境不支持自助备份",
  ...
  "settings.modelProvider.fetchModels.button": "获取模型",
  "settings.modelProvider.fetchModels.title": "获取模型",
  "settings.modelProvider.fetchModels.description":
    "从 {provider} 拉取可用模型列表，勾选后加入模型列表。",
  "settings.modelProvider.fetchModels.searchPlaceholder": "搜索模型",
  "settings.modelProvider.fetchModels.retry": "重新获取",
  "settings.modelProvider.fetchModels.loading": "正在获取模型列表…",
  "settings.modelProvider.fetchModels.empty": "没有可添加的模型",
  "settings.modelProvider.fetchModels.already": "已添加",
  "settings.modelProvider.fetchModels.selected": "已选 {count} 个",
  "settings.modelProvider.fetchModels.cancel": "取消",
  "settings.modelProvider.fetchModels.add": "添加选中",
  "settings.modelProvider.fetchModels.adding": "添加中…",
  ...
  // 移动端远程控制（自托管中继）：自托管版新增，官方对应文案在同名前缀下
  "webRemoteControl.trigger": "移动端远程控制",
  "webRemoteControl.title": "移动端远程控制",
  "webRemoteControl.description": "扫码或在手机上打开链接，即可远程控制当前工作区。",
  "webRemoteControl.refresh": "刷新状态",
  "webRemoteControl.qrAlt": "移动端远程控制二维码",
  "webRemoteControl.copyLink": "复制链接",
  "webRemoteControl.copied": "已复制",
  "webRemoteControl.status.disabled": "远程控制未开启",
  "webRemoteControl.status.connecting": "正在连接中继服务",
  "webRemoteControl.status.waiting": "等待手机连接",
  "webRemoteControl.status.connected": "手机已连接",
  "webRemoteControl.statusDetail.disabled":
    "自托管中继未启用（可用 ZCODE_SELFHOST_RELAY_DISABLED 控制）。",
  "webRemoteControl.statusDetail.connecting": "正在建立与自托管中继服务的连接…",
  "webRemoteControl.statusDetail.waiting": "用手机扫码，或在手机上打开链接。",
  "webRemoteControl.statusDetail.connected": "手机可以远程操控当前工作区。",
};
